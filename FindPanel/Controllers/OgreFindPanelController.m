...
- (void)awakeFromNib
{
    ...
    // 検索パネルらしい振る舞いをさせる
    [[self findPanel] setCollectionBehavior:NSWindowCollectionBehaviorCanJoinAllSpaces | NSWindowCollectionBehaviorTransient | NSWindowCollectionBehaviorFullScreenAuxiliary];
}
